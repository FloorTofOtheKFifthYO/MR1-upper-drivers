...
void load_prams()
{
  ...
  uprintf("\r\n");
  speed_P=flash_data[1];
  speed_I=flash_data[2];
  speed_D=flash_data[3];
  position_P=flash_data[4];
  position_I=flash_data[5];
  position_D=flash_data[6];
  angle_K=flash_data[7];
  angle_B=flash_data[8]; 
}
